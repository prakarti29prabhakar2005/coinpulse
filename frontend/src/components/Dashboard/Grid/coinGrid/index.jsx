...
function CoinGrid({ coin, delay }) {

  // ⭐ IMPORTANT — separate crypto watchlist
  const cryptoWatchlist =
    JSON.parse(localStorage.getItem("cryptoWatchlist")) || [];

  const [isCoinAdded, setIsCoinAdded] =
    useState(cryptoWatchlist.includes(coin.id));
...
//                   removeItemToWatchlist(e, coin.id,"crypto");
//                 } else {
//                   setIsCoinAdded(true);
//                   saveItemToWatchlist(e, coin.id,"crypto");
//                 }
//               }}
//             >
//               {isCoinAdded ? <StarIcon /> : <StarOutlineIcon />}
